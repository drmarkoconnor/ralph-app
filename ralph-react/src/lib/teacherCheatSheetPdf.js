...
export async function generateTeacherCheatSheetPDF(options = {}) {
  ...
  doc.setFontSize(8)
  doc.setFont('helvetica', 'normal')
  doc.text('Generator & Player workflow | Deterministic ACOL advisor | Teaching-focused features', pageW / 2, y, { align: 'center' })
  y += 6
  ...
  doc.text(`Generated ${dateStr} | Ralph App Usage Guide`, pageW / 2, 291, { align: 'center' })
  doc.setFontSize(6)
