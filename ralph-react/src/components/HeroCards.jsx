export default function HeroCards() {
	...
	const Card = ({ children, rotate = 0, x = 0, y = 0, back = false }) => (
		<div
			...
			{!back ? (
				<div className="text-3xl font-extrabold select-none">{children}</div>
			) : (
	...
	return (
		<div className="relative w-[420px] h-[260px]">
			...
			{/* Faces */}
			<Card rotate={-8} x={-60} y={-8}>
				Q♠
			</Card>
			<Card rotate={6} x={60} y={-10}>
				K♥
			</Card>
			<Card rotate={-2} x={0} y={8}>
				A♦
			</Card>
			<Card rotate={10} x={-5} y={-30}>
				J♣
			</Card>
		</div>
	)
