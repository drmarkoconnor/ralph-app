...
export async function computeDealHashV1(ownerString52: string): Promise<string> {
...
export function ownerStringFromHands(hands: Record<Seat, {S:string[];H:string[];D:string[];C:string[]}>): string {
